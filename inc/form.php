      ...
      <div class="col-md-10 col-md-offset-1">
        ...
        <div id='sslform'>
          <form class="form-horizontal">
            <p>Fill in either hostname:port (or host:ip to test a specific hostname on an IP) or paste a CSR/Certficiate. Port defaults to 443. <br></p>
            <fieldset>
              <div class="form-group">
                <label class="col-md-1 control-label" for="host">Host </label>  
                <div class="col-md-5">
                  <input id="host" name="host" type="text" placeholder="www.maverik.com" autofocus="autofocus" class="form-control input-md" >
                </div>
